...
const Checkbox = ({
  ...
  const [contextCombinedProps] = _react.default.useState({ ...checkboxGroupContext,
    ...combinedProps
  });
...
const CheckboxComponent = /*#__PURE__*/_react.default.memo(({
  ...
  const {
    ...
    onBlur,
    ...resolvedProps
  } = (0, _useThemeProps.usePropsResolution)('Checkbox', inputProps, {
    isInvalid,
    isReadOnly,
    isIndeterminate,
    isDisabled,
  ...
  const [accessibilityProps, nonAccessibilityProps] = (0, _utils3.extractInObject)(nonLayoutProps, ['accessibilityRole', 'accessibilityState']); //TODO: refactor for responsive prop

  if ((0, _useHasResponsiveProps.useHasResponsiveProps)(resolvedProps)) {
    return null;
  }

  return /*#__PURE__*/_react.default.createElement(_Pressable.Pressable, _extends({}, pressableProps, accessibilityProps, {
    onPress: onPress,
  ...
  }), /*#__PURE__*/_react.default.createElement(_Box.default, layoutProps, /*#__PURE__*/_react.default.createElement(_Center.Center, null, /*#__PURE__*/_react.default.createElement(_Box.default, _extends({}, _interactionBox, {
    p: 5,
    w: "100%",
    height: "100%",
    zIndex: -1
  })), /*#__PURE__*/_react.default.createElement(_Center.Center, nonAccessibilityProps, /*#__PURE__*/_react.default.createElement(_SizedIcon.default, {
    icon: icon,
    _icon: _icon,
    isChecked: isChecked
