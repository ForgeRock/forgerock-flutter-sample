...
export interface IImageProps extends PlatformProps<IImageProps>, Omit<ImageProps, 'borderRadius' | 'borderTopLeftRadius' | 'borderTopRightRadius' | 'borderBottomLeftRadius' | 'borderBottomRightRadius' | 'height' | 'width' | 'source'>, StyledProps {
    /**
