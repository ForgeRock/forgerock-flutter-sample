...
import { Box, Button, Pressable // Select,
, Image, Spinner, Text, Input, Checkbox, Slider // Icon,
, HStack, Heading } from '../../components/primitives'; // import { Ionicons } from '@expo/vector-icons';

import { FormControl, Menu } from '../../components/composites';
import { Platform } from 'react-native';
import { extendTheme } from '../../core/extendTheme';
import { fireEvent } from '@testing-library/react-native'; // import { InfoIcon } from '../../components/primitives/Icon/Icons';
...
describe('props resolution', () => {
  it('tests simple resolution', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Box, {
      p: 2,
      testID: "test"
    }, "hello world")));
  ...
  it('tests simple resolution with responsive props', () => {
    const {
      ...
      p: [2, 4, 5],
      testID: "test"
    }, "hello world"), /*#__PURE__*/React.createElement(Box, {
      p: {
        base: 1,
        sm: 5,
        lg: 10
  ...
  it('tests component sizes resolution', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Image, {
      source: {
  ...
  it('tests alpha opacity resolution', () => {
    ...
    const box = getByTestId('test');
    expect(box.props.style.backgroundColor).toBe('rgba(34, 211, 238, ' + defaultTheme.opacity['50'] + ')');
  });
  ...
  it('FormControl: pseudo props test ', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(FormControl, {
      isDisabled: true
    }, /*#__PURE__*/React.createElement(FormControl.HelperText, {
      testID: "test",
      _disabled: {
        borderLeftWidth: 1,
        mt: 1,
  ...
  it('Menu: style props test', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Menu, {
    ...
    }, /*#__PURE__*/React.createElement(Menu.Item, null, "Arial"), /*#__PURE__*/React.createElement(Menu.Item, {
      bg: "blue.300",
      testID: "test"
    }, "Nunito Sans"), /*#__PURE__*/React.createElement(Menu.Item, {
      testID: "test1",
      isDisabled: true,
      _disabled: {
        bg: 'pink.300'
    ...
    expect(menuItem.props.style.backgroundColor).toBe(defaultTheme.colors.blue['300']);
    expect(disabledMenuItem.props.style.backgroundColor).toBe(defaultTheme.colors.pink['300']);
  });
  it('Button: style props test', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Button, {
      testID: "test",
      bg: "pink.900",
      _text: {
        color: 'cyan.100',
    ...
    expect(buttonElement.props.style.backgroundColor).toBe(defaultTheme.colors.pink['900']);
  });
  ...
  it('Button: style responsive props test on ios with dark mode', () => {
    ...
    const buttonText = getByTestId('test1');
    expect(buttonText.props.style.color).toBe(defaultTheme.colors.cyan['100']);
    expect(buttonElement.props.style.backgroundColor).toBe(defaultTheme.colors.blue['900']);
  });
  ...
  it('Input: Basic check', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Input, {
      testID: "test",
      w: "100%",
      mx: 3,
    ...
    expect(inputElement.props.placeholderTextColor).toBe(defaultTheme.colors.blueGray['400']);
  ...
  it('Input: color mode', () => {
    ...
    const inputElement = getByTestId('test');
    expect(inputElement.props.placeholderTextColor).toBe(defaultTheme.colors.blueGray['50']);
  });
  it('Input: size', () => {
    const newTheme = extendTheme({
      config: {
  ...
  it('Input: style props test on ios with dark mode', () => {
    ...
    const inputElement = getByTestId('test');
    expect(inputElement.props.style.borderBottomWidth).toBe(1); // as input of 'sm' size is mapped to 'xs' fontsize
  ...
  it('Slider: basic', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Slider, {
      ...
      colorScheme: "red",
      size: "sm"
    }, /*#__PURE__*/React.createElement(Slider.Track, null, /*#__PURE__*/React.createElement(Slider.FilledTrack, null)), /*#__PURE__*/React.createElement(Slider.Thumb, null))));
  ...
  it('HStack: basic', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(HStack, {
      testID: "hstack"
    }, /*#__PURE__*/React.createElement(Box, null, "1"), /*#__PURE__*/React.createElement(Box, null, "2"), /*#__PURE__*/React.createElement(Box, null, "3"))));
  ...
  it('Pressable: style props test', () => {
    const {
      getByTestId
    } = render( /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Pressable, {
      testID: "test",
      bg: "red.200",
      _hover: {
        bg: 'teal.300'
    ...
    expect(pressableElement.props.style.backgroundColor).toBe(defaultTheme.colors.red['200']);
  ...
  it('HStack: style props test on ios & dark mode', () => {
    ...
    const {
      ...
      theme: newTheme
    }, /*#__PURE__*/React.createElement(Box, null, /*#__PURE__*/React.createElement(Text // @ts-ignore
    , {
      fontSize: "12px",
      testID: "test",
      lineHeight: "4xl",
    ...
    }, "This is a text"), /*#__PURE__*/React.createElement(Text, {
  ...
  it('Heading: style props test on ios with dark mode', () => {
    ...
    const {
      ...
      theme: newTheme
    }, /*#__PURE__*/React.createElement(Box, null, /*#__PURE__*/React.createElement(Heading // @ts-ignore
    , {
      fontSize: "12px",
      testID: "test",
      lineHeight: "4xl",
