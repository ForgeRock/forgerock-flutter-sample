...
const ActionsheetItem = (props, ref) => {
  const resolvedProps = (0, _hooks.usePropsResolution)('ActionsheetItem', props, undefined, {
  ...
  return /*#__PURE__*/_react.default.createElement(_Button.Button, _extends({}, resolvedProps, {
    ref: ref
  }));
};
