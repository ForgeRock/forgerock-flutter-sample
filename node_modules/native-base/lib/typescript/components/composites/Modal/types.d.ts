...
export declare type IModalComponentType = ((props: IModalProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Body: React.MemoExoticComponent<(props: IBoxProps<IModalProps> & {
        _scrollview?: IScrollViewProps;
    } & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    CloseButton: React.MemoExoticComponent<(props: IIconButtonProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Content: React.MemoExoticComponent<(props: IBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Footer: React.MemoExoticComponent<(props: IBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Header: React.MemoExoticComponent<(props: IBoxProps<IModalProps> & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};
