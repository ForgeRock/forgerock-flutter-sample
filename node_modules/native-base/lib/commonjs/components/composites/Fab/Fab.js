...
const Fab = (props, ref) => {
  const themeProps = (0, _useThemeProps.usePropsResolution)('FAB', props);
  const {
    label,
    icon,
    renderInPortal,
  ...
  const fabComponent = /*#__PURE__*/_react.default.createElement(_Button.Button, _extends({}, placementProps[placement], {
    ref: ref,
    startIcon: icon
