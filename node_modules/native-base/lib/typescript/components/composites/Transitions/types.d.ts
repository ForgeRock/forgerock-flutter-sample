...
export declare type IFadeProps = IBoxProps<IFadeProps> & {
    in?: boolean;
    entryDuration?: number;
    exitDuration?: number;
    delay?: number;
};
export declare type IScaleFadeProps = IBoxProps<IScaleFadeProps> & {
    in?: boolean;
    duration?: number;
    delay?: number;
    initialScale?: number;
};
export declare type ISlideProps = IBoxProps<ISlideProps> & {
    in?: boolean;
    duration?: number;
    delay?: number;
...
export declare type ISlideFadeProps = IBoxProps<ISlideFadeProps> & {
    in?: boolean;
    delay?: number;
    duration?: number;
    offsetX?: number;
