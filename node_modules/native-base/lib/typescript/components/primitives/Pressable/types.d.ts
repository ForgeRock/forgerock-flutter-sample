...
export interface IPressableProps<T = IPressableProps<unknown>> extends PressableProps, StyledProps, PlatformProps<T> {
    /**
    ...
    children?: React.ReactNode | (({ isPressed, isHovered, isFocused, }: {
        isPressed: boolean;
        isHovered: boolean;
        isFocused: boolean;
    }) => any);
