...
export declare type ISkeletonComponentType = ((props: ISkeletonProps & {
    ref?: MutableRefObject<any>;
}) => JSX.Element) & {
    Circle: React.MemoExoticComponent<(props: ISkeletonProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
    Text: React.MemoExoticComponent<(props: ISkeletonTextProps & {
        ref?: MutableRefObject<any>;
    }) => JSX.Element>;
};
