...
function getItemId(state, itemKey) {
  ...
  return data.id + "-option-" + $e25442753cf4918277b5a7f1d4$var$normalizeKey(itemKey);
}
...
function useOption(props, state, ref) {
  ...
  return {
    optionProps: _babelRuntimeHelpersExtends({}, optionProps, mergeProps(itemProps, hoverProps), {
