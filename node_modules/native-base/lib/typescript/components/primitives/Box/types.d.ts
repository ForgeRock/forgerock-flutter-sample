...
import type { SafeAreaProps, PlatformProps, ResponsiveValue, ColorType } from '../../types';
...
export interface IBoxProps<T = null> extends ViewProps, SafeAreaProps, PlatformProps<T extends null ? IBoxProps<any> : T>, Omit<StyledProps, 'bgColor' | 'background' | 'bg' | 'backgroundColor'> {
    /**
